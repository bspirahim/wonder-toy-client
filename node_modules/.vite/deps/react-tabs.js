...
var UncontrolledTabs = (props) => {
  ...
  return import_react2.default.createElement("div", Object.assign({}, attributes, { className: clsx_m_default(className), onClick: handleClick, onKeyDown: handleKeyDown, ref: (node) => {
    ref.current = node;
    if (domRef)
      domRef(node);
...
var Tab = (props) => {
  ...
  return import_react5.default.createElement("li", Object.assign({}, attributes, { className: clsx_m_default(className, { [selectedClassName]: selected, [disabledClassName]: disabled }), ref: (node) => {
...
var TabPanel = (props) => {
  ...
  return import_react6.default.createElement("div", Object.assign({}, attributes, { className: clsx_m_default(className, { [selectedClassName]: selected }), role: "tabpanel", id: `panel${id}`, "aria-labelledby": `tab${id}` }), forceRender || selected ? children : null);
};
