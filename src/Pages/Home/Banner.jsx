             ...
             <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute w-full h-full flex items-center left-0 bottom-0 bg-[rgba(0,0,0,0.5)]">
                    ...
                    <div className='text-white md:w-2/4 mx-auto text-center md:space-y-7 '>
                        ...
                        <button className='button-tab bg-primary/90 rounded-tl-lg rounded-br-lg text-white py-2 px-5 cursor-pointer text-lg uppercase' >Browse</button>
            ...
            <div id="slide2" className="carousel-item relative w-full">
                ...
                <div className="absolute w-full h-full flex items-center left-0 bottom-0 bg-[rgba(0,0,0,0.5)]">
                    ...
                    <div className='text-white w-2/4 mx-auto text-center space-y-7 '>
                        ...
                        <button className='button-tab bg-primary/90 rounded-tl-lg rounded-br-lg text-white py-2 px-5 cursor-pointer text-lg ' >Browse</button>
                    </div>
